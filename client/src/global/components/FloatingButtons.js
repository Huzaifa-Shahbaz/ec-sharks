...
const FloatingButtons = ({isScrolled, setDrawerOpened}) => {

    const scrollToTop = () => window.scrollTo({ top: 0 })

    return (
        <div className='floating-buttons'>
            <button className='btn rounded-button share' onClick={() => setDrawerOpened(true)}>
            ...
            <button
                className={isScrolled ? 'btn rounded-button up visible' : 'btn rounded-button up'}
                onClick={scrollToTop}
            >
                <svg viewBox="0 0 129 129" width='55px' height="55px" fill='currentcolor'>
                    <g>
